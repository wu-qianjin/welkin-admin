    ...
    type Schema = {
      ...
      page: {
        ...
        home: {
          ...
          todoAllDone: string;
          goHandle: string;
          todoReadMessages: string;
          todoBindPhone: string;
          todoBindEmail: string;
          todoUploadAvatar: string;
          todoCheckDevices: string;
          noticeBoard: string;
          noticeAll: string;
          noNotices: string;
          pinned: string;
          ...
          todoHandleAlerts: string;
          lastLogin: string;
          platformUsers: string;
          onlineUsers: string;
          roleCount: string;
          deptCount: string;
          noticeTotalLabel: string;
          unitPeople: string;
          unitRoles: string;
          unitDepts: string;
          unitNotices: string;
