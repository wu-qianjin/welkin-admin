...
const routeMetaByName: Record<string, Partial<RouteMeta>> = {
  auth: { icon: 'mdi:shield-account-outline', order: 8, roles: ['R_SYS_ADMIN'] },
  auth_user: { icon: 'ic:round-manage-accounts', order: 1, roles: ['R_SYS_ADMIN'], keepAlive: true },
  auth_dept: { icon: 'mdi:account-multiple-outline', order: 2, roles: ['R_SYS_ADMIN'], keepAlive: true },
  auth_role: { icon: 'carbon:user-role', order: 3, roles: ['R_SUPER'], keepAlive: true },
  auth_menu: { icon: 'material-symbols:route', order: 4, roles: ['R_SYS_ADMIN'], keepAlive: true },
  auth_resource: { icon: 'mdi:api', order: 5, roles: ['R_SUPER'], keepAlive: true },
  system: { icon: 'mdi:cog-outline', order: 9, roles: ['R_SYS_ADMIN'] },
  ...
  system_notice: { icon: 'mdi:bullhorn-outline', order: 3, roles: ['R_SYS_ADMIN'], keepAlive: true },
  system_file: { icon: 'mdi:folder-file-outline', order: 4, roles: ['R_SYS_ADMIN'], keepAlive: true },
